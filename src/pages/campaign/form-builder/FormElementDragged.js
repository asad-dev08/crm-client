    ...
    switch (element.type) {
      case "div":
        return (
          <div
            id={element.id}
            className={`text-left relative w-full border border-dashed border-slate-400 px-2 pt-4 pb-6 my-2 text-slate-800 `}
            style={{
      ...
      case "button":
        return (
          <div className="text-left relative border border-dashed border-slate-100">
            <Form.Item className="">
              <Button
                key={element.id}
                id={element.id}
      ...
      case "list":
        return (
          <div className="relative">
            ...
            <Form.Item className="" name={element.elementName}>
              <List
                dataSource={
