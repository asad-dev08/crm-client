...
function CampaignFormBuilder() {
  ...
  const [isTextBoxRequired, setIsTextBoxRequired] = useState(false);
          ...
          updatedChildren = [
            {
              ...
              isTextBoxRequired: isTextBoxRequired,
  ...
  const handleDrop = (e, targetId) => {
    ...
    if (isTargetDiv) {
      if (draggedElement.content === "div") {
        columnsToPush = prompt("Enter the number of columns to push:", "1");
      }
  ...
  const deleteElementFromDraggedItems = (draggedItem, id) => {
    for (let i = 0; i < draggedItem.length; i++) {
      ...
      if (draggedItem[i].children) {
        if (deleteElementFromDraggedItems(draggedItem[i].children, id)) {
          return true;
        }
      }
    }
  ...
  const setStyleOfElements = (id, items, styleObj) => {
    for (let i = 0; i < items.length; i++) {
      ...
      if (items[i].children.length > 0) {
        const childResult = setStyleOfElements(id, items[i].children, styleObj);
        if (childResult) {
            ...
            {draggedItem.map((element) => (
              <>
                <FormElementDragged
                  ...
                  updateElementWithStyle={updateElementWithStyle}
                />
              </>
            ))}
          </div>
        ...
        <div>
          <label>
            <input
              ...
              onChange={(e) => setImageUploadOption(e.target.value)}
            />
            Single Image
          </label>
          <label>
        ...
        <div>
          <label>
            <input
              ...
              onChange={(e) => setImageSourceOption(e.target.value)}
            />
            User Upload
          </label>
          <label>
        ...
        <div>
          <label>
            ...
            <Input
              ...
              onChange={(e) => setDropdownOptions(e.target.value.split(","))}
            />
          </label>
        </div>
      </Modal>
        ...
        <div>
          <label>
            ...
            <Input
              ...
              onChange={(e) => setListOptions(e.target.value.split(","))}
            />
          </label>
        </div>
      </Modal>
        ...
        <div>
          <label>
            ...
            <Input
              ...
              onChange={(e) => setRadioOptions(e.target.value.split(","))}
            />
          </label>
        </div>
      </Modal>
        ...
        <div>
          <label>
            ...
            <Input
              ...
              onChange={(e) => setCheckboxOptions(e.target.value.split(","))}
            />
          </label>
        </div>
      </Modal>
        ...
        <div className="flex flex-col gap-3">
          ...
          <label>
            ...
            <Input
              ...
              onChange={(e) => setTextBoxPlaceholder(e.target.value)}
            />
          </label>
          <label>
            Required?:
            <Checkbox
              value={isTextBoxRequired}
              onChange={(e) => setIsTextBoxRequired(e.target.checked)}
            />
          </label>
          <label>
            Required Message:
