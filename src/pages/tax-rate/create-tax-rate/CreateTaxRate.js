...
const CreateTaxRate = ({ onClose, open, data, isAdd }) => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      if (isAdd) {
        await dispatch(saveTaxRate(model))
          .then((response) => {
            if (
              response &&
              response.payload &&
        ...
        await dispatch(updateTaxRate(model))
          .then((response) => {
            if (
              response &&
              response.payload &&
